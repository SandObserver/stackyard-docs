...
import { PE_SVG, CHEV_SVG, initInlineEdit } from '/js/admin-shared.js?v=d7dd8b71';
import { renderWidgetConfigForm } from '/js/widget-config-form.js?v=02918336';
...
import { q, qi, qa } from '/js/utils.js?v=4c1189b9';
