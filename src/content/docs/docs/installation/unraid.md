...
Open the WebUI link from the Docker tab, then work through [First setup](/docs/first-setup/).

Stackyard can read system stats from the Unraid API. Set the System Summary widget's source to Unraid. See [System summary](/docs/widgets/system-summary/).
