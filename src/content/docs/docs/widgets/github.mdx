...
The token is stored as a secret. It is kept on the server and never sent back to the browser. If the widget shows **Key rejected**, the value is wrong, expired, or missing a scope.
