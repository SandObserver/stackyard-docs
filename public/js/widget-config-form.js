...
import { wireChecklist } from '/js/admin-shared.js?v=d7dd8b71';
import { renderColorControl } from '/js/admin-color-control.js?v=f638b750';
import {
  seedCarried,
  applyOptionSet,
  collectFieldValues,
...
import { qi } from '/js/utils.js?v=4c1189b9';
