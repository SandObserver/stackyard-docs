...
<figure class="sy-shot">
  <img class="sy-shot__light" src="/img/admin/app-edit-basics-b3c6980e.png" alt="The app edit form, showing Name, URL, Icon and Color" loading="lazy"><img class="sy-shot__dark" src="/img/admin/app-edit-basics-dark-2910e8f5.png" alt="The app edit form, showing Name, URL, Icon and Color" loading="lazy">
...
<figure class="sy-shot">
  <img class="sy-shot__light" src="/img/admin/dashboard-list-0d98d7b7.png" alt="The Dashboard list, with drag handles, move arrows and an Edit button on each row" loading="lazy"><img class="sy-shot__dark" src="/img/admin/dashboard-list-dark-e87991d0.png" alt="The Dashboard list, with drag handles, move arrows and an Edit button on each row" loading="lazy">
...
<figure class="sy-shot">
  <img class="sy-shot__light" src="/img/admin/dashboard-apps-3dd6a50c.png" alt="The list filtered to apps, showing Dock and Badge tags" loading="lazy"><img class="sy-shot__dark" src="/img/admin/dashboard-apps-dark-34e8c0e1.png" alt="The list filtered to apps, showing Dock and Badge tags" loading="lazy">
